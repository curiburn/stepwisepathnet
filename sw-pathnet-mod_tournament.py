...
def main(args):
    ...
    pathnet = swpathnet_func.sw_pathnet(pre_model, args.n_comp, args.num_classes, args.transfer_all, is_reuse_initweight=args.finetune)
    ...
    df_data
    epoch_log_name = 'swpathnet_mod-tournament-%s_%s.csv' % (args.model_name, args.learning_number)
